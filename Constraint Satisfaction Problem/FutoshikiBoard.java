...
public class FutoshikiBoard implements Board{
    private Variable[][] board;

    public FutoshikiBoard(String filePath) throws FileNotFoundException {
        DataReader dataReader = new DataReader();
        this.board = dataReader.readFutoshikiBoard(filePath);
    }
