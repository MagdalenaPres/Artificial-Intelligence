...
public class ValidMoves
{
    ...
    private Player copyOppositePlayer(Pawn oppositePawn, Player oppositePlayer) {
        ...
        {
            newOppositePlayer = new BotPlayer(oppositePlayer.getName(), oppositePlayer.isWhite(), ((BotPlayer) oppositePlayer).isWithMinMax());
        }
    ...
    private Player copyCurrentPlayer(int y, int x, Pawn playerPawn, Player currentPlayer) {
        ...
        {
            newPlayer = new BotPlayer(currentPlayer.getName(), currentPlayer.isWhite(), ((BotPlayer)currentPlayer).isWithMinMax());
        }
