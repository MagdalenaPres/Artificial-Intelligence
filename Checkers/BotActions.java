...
public class BotActions
{
    ...
    private int visitedNodesMinMax = 0;
    private int visitedNodesAlphaBetaPruning = 0;
    ...
    public int getVisitedNodesMinMax() {
        return visitedNodesMinMax;
    }
    public int getVisitedNodesAlphaBetaPruning() {
        return visitedNodesAlphaBetaPruning;
    }

    private Player prepareNewPlayer(Player player) {
        Player newPlayer;
        if(player.isHuman()) newPlayer = new HumanPlayer(player.getName(), player.isWhite());
        else newPlayer = new BotPlayer(player.getName(), player.isWhite(), ((BotPlayer) player).isWithMinMax());
